...
import image from "/Beranda/Menu1/image1.png";
import image2 from "/Beranda/Menu1/image2.png";
import image3 from "/Beranda/Menu1/image3.png";
...
function Home() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen p-4">
      <Banner />
      <h1 className="beranda-text text-start mb-5 text-3xl text-white">
        Temukan Yang Ingin Anda Cari
      </h1>
      <div className="w-full max-w-screen-xl grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="relative flex items-center justify-between sm:inline rounded-md shadow-lg overflow-hidden">
          <img
            src={image2}
            alt=""
            className="sm:w-full relative sm:h-full w-52 h-28 object-cover rounded-md"
          />
